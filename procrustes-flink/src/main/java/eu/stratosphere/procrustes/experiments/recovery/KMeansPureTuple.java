...
public class KMeansPureTuple {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple4<Integer, Double, Double, Double>> centroids = getCentroidDataSet(env);

        // set number of bulk iterations for KMeans algorithm
        IterativeDataSet<Tuple4<Integer, Double, Double, Double>> loop = centroids.iterate(numIterations);

        if (checkpointInterval > 0) {
            loop.setCheckpointInterval(checkpointInterval);
        }

        DataSet<Tuple4<Integer, Double, Double, Double>> newCentroids = points
        ...
        DataSet<Tuple4<Integer, Double, Double, Double>> finalCentroids = loop.closeWith(newCentroids);
    ...
    public static final class TupleCentroidConverter implements MapFunction<Tuple4<Integer, Double, Double, Double>, Tuple1<Centroid>> {

        @Override
        public Tuple1<Centroid> map(Tuple4<Integer, Double, Double, Double> t) throws Exception {

            Centroid centroid = new Centroid(t.f0, t.f1, t.f2, t.f3);
            return new Tuple1<Centroid>(centroid);
        }
    }
    ...
    public static final class SelectNearestCenter extends RichMapFunction<Point, Tuple2<Integer, Point>> {
        ...
        private Collection<Tuple4<Integer, Double, Double, Double>> centroids;
        ...
        public Tuple2<Integer, Point> map(Point p) throws Exception {
            ...
            for (Tuple4<Integer, Double, Double, Double> tuple_centroid : centroids) {

                Centroid centroid = new Centroid(tuple_centroid.f0, tuple_centroid.f1, tuple_centroid.f2, tuple_centroid.f3);
    ...
    public static final class CentroidAverager implements MapFunction<Tuple3<Integer, Point, Long>, Tuple4<Integer, Double, Double, Double>> {

        @Override
        public Tuple4<Integer, Double, Double, Double> map(Tuple3<Integer, Point, Long> value) {
            return new Tuple4<Integer, Double, Double, Double>(value.f0, value.f1.x / value.f2, value.f1.y / value.f2, value.f1.z / value.f2);
        }
    }
    ...
    private static DataSet<Tuple4<Integer, Double, Double, Double>> getCentroidDataSet(ExecutionEnvironment env) {
