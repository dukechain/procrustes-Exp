package eu.stratosphere.procrustes.experiments.core;
...
public final class AppRunner {
    ...
    public void run(String[] args) {
        ...
        //@formatter:off
        ArgumentParser parser = ArgumentParsers.newArgumentParser(String.format("procrustes-%s", cliName), false)
                .defaultHelp(true)
                .description(String.format("Run an experiment on %s", systemName));
